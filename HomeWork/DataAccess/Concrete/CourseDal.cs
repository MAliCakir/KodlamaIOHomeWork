...
namespace HomeWork.DataAccess.Concrete
{
    ...
    public class CourseDal : ICourseDal
    {
        ...
        public CourseDal()
        {
            ...
            Course course5 = new Course() { Id = 5, Name = "2022 Yazılım Geliştirici Yetiştirme Kampı", Description = "Java", Author = new List<Instructor>().Where(i => i.FirstName == "Engin" && i.LastName == "DEMİROĞ").ToList(), Price = "Free" };
